...
// 1. MiddlewareInvalidContextSignal (not retryable)
// 2. TimeoutSignal (not retryable)
// 3. RetryExceededSignal (not retryable)
...
export const ERROR_SIGNAL_PRIORITY =              0b0000_0000_0000_0000; /* prettier-ignore */
